...
when_to_use: Use when: "Interactive multi-channel image visualization in R"; Single-cell RNA-seq analysis (cytoviewer). Not for: Requires R ≥ 4.0.0 and Bioconductor ≥ 3.16
