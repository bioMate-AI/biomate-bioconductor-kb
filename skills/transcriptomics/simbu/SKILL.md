...
when_to_use: Use when: Getting started; Public Data Integration using Sfaira; Inputs and Outputs; Introducing mRNA bias into simulations with scaling factors; Single-cell RNA-seq analysis (SimBu). Not for: Requires R ≥ 4.0.0 and Bioconductor ≥ 3.16
