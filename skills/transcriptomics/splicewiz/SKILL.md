...
when_to_use: Use when: SpliceWiz: the cookbook; SpliceWiz: Quick Start; Differential expression analysis (SpliceWiz). Not for: Requires R ≥ 3.5.0 and Bioconductor ≥ 3.16
